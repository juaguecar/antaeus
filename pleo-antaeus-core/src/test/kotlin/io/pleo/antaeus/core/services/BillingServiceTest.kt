...
class BillingServiceTest {
    ...
    @Test
    fun `If invoice is already PAID we return same invoice and dont interact with any other service`() {
        val expected =
            Invoice(1, 1, Money(BigDecimal.valueOf(10000000), Currency.EUR), InvoiceStatus.PAID)
    ...
    @Test
    fun `If user exists but payment is not successful we should update the invoice with status ERROR`() {
